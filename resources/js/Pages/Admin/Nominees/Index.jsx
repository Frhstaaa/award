    ...
    return (
        <AdminLayout title="Manajemen Nominasi Award">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-sm dark:bg-[#0a0f1d] dark:border-amber-500/15 flex items-center gap-3.5 dark:shadow-lg">
                    <div className="p-2.5 rounded-xl bg-amber-500/10 border border-amber-500/25 text-amber-500 dark:text-amber-400">
                        <Users className="w-5 h-5" />
                    </div>
                    <div>
                        <div className="text-xl font-bold font-display text-slate-900 dark:text-slate-100">{totalNominations}</div>
                        <div className="text-[11px] text-slate-600 dark:text-slate-400">Total Nominasi Dibuat</div>
                    </div>
                </div>

                <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-sm dark:bg-[#0a0f1d] dark:border-amber-500/15 flex items-center gap-3.5 dark:shadow-lg">
                    <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/25 text-emerald-600 dark:text-emerald-400">
                        <UserCheck className="w-5 h-5" />
                    </div>
                    <div>
                        <div className="text-xl font-bold font-display text-slate-900 dark:text-slate-100">{uniqueNominatedEmployeesCount}</div>
                        <div className="text-[11px] text-slate-600 dark:text-slate-400">Karyawan Ternominasi</div>
                    </div>
                </div>

                <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-sm dark:bg-[#0a0f1d] dark:border-amber-500/15 flex items-center gap-3.5 dark:shadow-lg">
                    <div className="p-2.5 rounded-xl bg-blue-500/10 border border-blue-500/25 text-blue-600 dark:text-blue-400">
                        <Award className="w-5 h-5" />
                    </div>
                    <div>
                        <div className="text-xl font-bold font-display text-slate-900 dark:text-slate-100">{categoriesWithNomineesCount} / {categories.length}</div>
                        <div className="text-[11px] text-slate-600 dark:text-slate-400">Kategori Terisi</div>
                    </div>
                </div>

                <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-sm dark:bg-[#0a0f1d] dark:border-amber-500/15 flex items-center gap-3.5 dark:shadow-lg">
                    <div className="p-2.5 rounded-xl bg-amber-400/10 border border-amber-400/25 text-amber-600 dark:text-amber-300">
                        <Star className="w-5 h-5 fill-current" />
                    </div>
                    <div>
                        <div className="text-xl font-bold font-display text-slate-900 dark:text-slate-100">{winnersCount}</div>
                        <div className="text-[11px] text-slate-600 dark:text-slate-400">Pemenang Ditetapkan</div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <h3 className="text-xl font-display font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                        ...
                        <span className="px-2.5 py-0.5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-300 border border-amber-500/25 text-xs font-mono font-medium">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-9 pr-4 py-2 rounded-xl bg-white border border-slate-300 text-xs text-slate-800 placeholder-slate-400 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-200 dark:placeholder-slate-500 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 w-44 sm:w-56 shadow-sm"
                        />
                    </div>
                    ...
                    <select
                        ...
                        className="px-3 py-2 rounded-xl bg-white border border-slate-300 text-xs text-slate-800 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-200 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 shadow-sm"
                    >
                    ...
                    <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
                        ...
                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800/80">
                            {filteredNominees.length === 0 ? (
                                <tr>
                                    <td colSpan="6" className="text-center py-14 text-slate-400 dark:text-slate-500">
                                ...
                                filteredNominees.map((nominee) => {
                                    ...
                                    return (
                                        <tr key={nominee.id} className="hover:bg-amber-50/50 dark:hover:bg-slate-900/40 transition-colors group">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 dark:bg-slate-800 dark:border-slate-700 overflow-hidden flex-shrink-0 flex items-center justify-center relative">
                                                        {emp.photo_url ? (
                                                        ...
                                                        <div className="font-semibold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                                                            ...
                                                            {totalOtherNom > 0 && (
                                                                <span 
                                                                    ...
                                                                    className="px-1.5 py-0.2 rounded bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-300 text-[10px] font-mono"
                                                                >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-300 text-xs font-medium">
                                            ...
                                            <td className="px-6 py-4 max-w-sm">
                                                {nominee.description ? (
                                                    <span className="text-xs text-slate-700 dark:text-slate-300 italic line-clamp-2" title={nominee.description}>
                                                        "{nominee.description}"
                                                    </span>
                                                ) : (
                                                    <span className="text-xs text-slate-400 dark:text-slate-600 italic">- Tidak ada deskripsi -</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-4 text-center font-mono font-bold text-amber-600 dark:text-amber-300 text-xs">
                                                #{nominee.order}
                                            </td>
                                            <td className="px-6 py-4 text-center">
                                                {isWinner ? (
                                                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-amber-500/20 text-amber-700 dark:text-amber-300 text-xs font-semibold border border-amber-400/40 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
                                                        <Star className="w-3 h-3 fill-current" />
                                                        Pemenang
                                                    </span>
                                                ) : (
                                                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-600 border border-slate-200 dark:bg-slate-800 dark:text-slate-400 text-xs dark:border-slate-700">
                                                        Kandidat
                                                    </span>
                                                )}
                                            </td>
            ...
            {isAssignModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 dark:bg-black/80 backdrop-blur-md overflow-y-auto">
                    <div className="relative w-full max-w-3xl rounded-3xl bg-white border border-amber-500/30 dark:bg-[#0c1222] p-5 sm:p-7 shadow-2xl my-auto">
                        {/* Modal Header */}
                        <div className="flex items-center justify-between pb-4 mb-5 border-b border-slate-200 dark:border-slate-800">
                            ...
                            <button 
                                ...
                                className="p-1.5 rounded-xl text-slate-400 hover:text-slate-600 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleAssignSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 text-sm focus:border-amber-400 focus:ring-1 focus:ring-amber-400 font-medium"
                                    required
                                >
                                    {categories.map((cat) => {
                                ...
                                {assignErrors.category_id && <p className="text-xs text-rose-500 dark:text-rose-400 mt-1">{assignErrors.category_id}</p>}
                            </div>
                            ...
                            <div>
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                                    ...
                                    <div className="flex items-center gap-2 text-xs">
                                        <button
                                            ...
                                            className="text-amber-600 dark:text-amber-400 hover:underline disabled:text-slate-400 dark:disabled:text-slate-600 disabled:no-underline font-medium"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="text-slate-500 dark:text-slate-400 hover:underline disabled:text-slate-400 dark:disabled:text-slate-600 disabled:no-underline"
                                        >
                                            Kosongkan
                                        </button>
                                    </div>
                                ...
                                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mb-2.5">
                                    ...
                                    <div className="relative flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-8 pr-3 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-900/90 border border-slate-300 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                                        />
                                        {employeeSearchQuery && (
                                            <button
                                                type="button"
                                    ...
                                    <select
                                        ...
                                        className="px-2.5 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-900/90 border border-slate-300 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-200 focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                                    >
                                ...
                                {assignData.employee_ids.length > 0 && (
                                    <div className="mb-2.5 p-2 rounded-xl bg-amber-50 dark:bg-amber-500/5 border border-amber-300 dark:border-amber-500/20 max-h-20 overflow-y-auto">
                                        <div className="text-[10px] uppercase font-bold text-amber-700 dark:text-amber-400/90 mb-1 flex items-center gap-1">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {assignData.employee_ids.map(id => {
                                                ...
                                                return (
                                                    <span 
                                                        key={id}
                                                        className="inline-flex items-center gap-1 pl-2 pr-1.5 py-0.5 rounded-md bg-white border border-amber-300 text-amber-900 dark:bg-amber-500/20 dark:border-amber-500/30 dark:text-amber-200 text-[11px] font-medium shadow-xs"
                                                    >
                                                        <span>{emp.name}</span>
                                                        <button
                                                            type="button"
                                ...
                                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-[#090d19] max-h-64 sm:max-h-72 overflow-y-auto p-2 space-y-1.5 divide-y divide-slate-200 dark:divide-slate-800/40">
                                                ...
                                                <div
                                                    ...
                                                    className={`pt-1.5 first:pt-0 flex items-center justify-between gap-3 p-2 rounded-xl transition-all ${
                                                        isAlreadyNominated
                                                            ...
                                                            : isSelected
                                                            ? 'bg-amber-100/70 dark:bg-amber-500/15 border border-amber-300 dark:border-amber-500/40 shadow-sm cursor-pointer'
                                                            : 'hover:bg-white dark:hover:bg-slate-800/60 border border-transparent cursor-pointer'
                                                    }`}
                                                >
                                                    <div className="flex items-center gap-2.5 min-w-0">
                                                        ...
                                                        <div className="flex-shrink-0 text-amber-500 dark:text-amber-400">
                                                            {isAlreadyNominated ? (
                                                                ...
                                                                <CheckSquare className="w-4 h-4 text-amber-500 dark:text-amber-400 fill-amber-400/20" />
                                                            ) : (
                                                        ...
                                                        {/* Photo */}
                                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 dark:bg-slate-800 dark:border-slate-700 overflow-hidden flex-shrink-0 flex items-center justify-center">
                                                            {emp.photo_url ? (
                                                                <img src={emp.photo_url} alt="" className="w-full h-full object-cover object-top" />
                                                            ) : (
                                                        ...
                                                        <div className="min-w-0">
                                                            <div className="text-xs font-semibold text-slate-800 dark:text-slate-100 truncate flex items-center gap-1.5">
                                                                <span className={isSelected ? 'text-amber-700 dark:text-amber-300 font-bold' : ''}>{emp.name}</span>
                                                            ...
                                                            <div className="text-[11px] text-slate-600 dark:text-slate-400 truncate">
                                                                {emp.position} • <span className="text-slate-700 dark:text-slate-300">{emp.department}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        {isAlreadyNominated ? (
                                                            ...
                                                            <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-200/80 text-slate-600 dark:bg-slate-800/80 dark:text-slate-400 group-hover:text-slate-800 dark:group-hover:text-slate-200">
                                                                + Pilih
                                                            </span>
                                                        )}
                                                    </div>
                                ...
                                <p className="text-[11px] text-amber-700 dark:text-amber-300/80 mt-1.5 flex items-center gap-1.5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 text-xs focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                                />
                                {assignErrors.description && <p className="text-xs text-rose-500 dark:text-rose-400 mt-1">{assignErrors.description}</p>}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-800">
                                <div className="text-xs text-slate-600 dark:text-slate-400 font-medium">
                                    {assignData.employee_ids.length > 0 ? (
                                        ...
                                        <span className="text-slate-400 dark:text-slate-500">Pilih minimal 1 karyawan</span>
                                    )}
                                </div>
            ...
            {isEditModalOpen && editingNominee && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm">
                    <div className="relative w-full max-w-lg rounded-3xl bg-white border border-amber-500/30 dark:bg-[#0c1222] p-6 shadow-2xl">
                        <div className="flex items-center justify-between pb-4 mb-5 border-b border-slate-200 dark:border-slate-800">
                            <div>
                                <h3 className="text-lg font-display font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                                    <Edit2 className="w-5 h-5 text-amber-500 dark:text-amber-400" />
                            ...
                            <button onClick={closeEditModal} className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleEditSubmit} className="space-y-4">
                            {/* Candidate Info Box */}
                            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 dark:bg-slate-900/80 dark:border-slate-800 flex items-center gap-3">
                                <div className="w-11 h-11 rounded-xl bg-white border border-slate-200 dark:bg-slate-800 dark:border-slate-700 overflow-hidden flex-shrink-0 flex items-center justify-center">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="text-xs text-amber-600 dark:text-amber-400/90 font-medium mt-0.5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                {editErrors.order && <p className="text-xs text-rose-500 dark:text-rose-400 mt-1">{editErrors.order}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {editErrors.description && <p className="text-xs text-rose-500 dark:text-rose-400 mt-1">{editErrors.description}</p>}
                            </div>
