                    ...
                    return (
                        <div
                            ...
                            className={`p-6 rounded-3xl border transition-all shadow-xl ${
                                winner
                                    ? 'bg-gradient-to-br from-amber-50/90 via-white to-amber-100/50 border-amber-400/50 shadow-sm dark:bg-gradient-to-br dark:from-[#0c1429] dark:via-[#091024] dark:to-[#121a36] dark:border-amber-500/40 dark:shadow-gold-glow/20'
                                    : 'bg-white border-slate-200/90 shadow-sm dark:bg-[#0a0f1d] dark:border-slate-800'
                            }`}
                        >
                            {/* Category Header */}
                            <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800/80 mb-5">
                                <div className="flex items-center gap-2.5">
                                    <div className="w-8 h-8 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400 text-xs font-bold font-mono">
                                        #{category.order}
                                    </div>
                                    <div>
                                ...
                                {winner ? (
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-400/30 text-xs font-bold font-display uppercase tracking-wider">
                                        <Star className="w-3.5 h-3.5 fill-current" />
                                        Pemenang Siap
                                    </span>
                                ) : (
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-600 border border-slate-200 dark:bg-slate-800 dark:text-slate-400 text-xs font-medium dark:border-slate-700">
                                        Pending
                                    </span>
                                )}
                            </div>
                            ...
                            {winner && winnerEmp ? (
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/90 dark:bg-black/40 border border-amber-300 dark:border-amber-500/25 shadow-xs">
                                        <div className="w-16 h-16 rounded-2xl p-0.5 bg-gradient-to-tr from-amber-500 to-yellow-300 shadow-gold-glow flex-shrink-0">
                                            <div className="w-full h-full rounded-[14px] overflow-hidden bg-slate-100 dark:bg-slate-900">
                                                {winnerEmp.photo_url ? (
                                                    ...
                                                    <User className="w-8 h-8 text-slate-400 dark:text-slate-600 m-auto" />
                                                )}
                                            </div>
                                        </div>

                                        <div className="flex-1 min-w-0">
                                            <div className="text-[10px] text-amber-600 dark:text-amber-400 uppercase font-mono tracking-widest font-semibold">
                                                Pemenang Terpilih
                                            </div>
                                            <h5 className="font-display font-bold text-slate-900 dark:text-slate-100 text-base gold-shimmer truncate">
                                                {winnerEmp.name}
                                            </h5>
                                ...
                                <div className="text-center py-6">
                                    <Trophy className="w-10 h-10 text-slate-400 dark:text-slate-600 mx-auto mb-2 opacity-60" />
                    ...
                    <div className="relative w-full max-w-lg rounded-3xl bg-white border border-amber-500/30 dark:bg-[#0c1222] p-6 md:p-8 shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                        ...
                                        return (
                                            <label
                                                ...
                                                className={`flex items-center gap-3 p-3.5 rounded-2xl border cursor-pointer transition-all ${
                                                    isSelected
                                                        ? 'bg-amber-100/80 border-amber-400/80 dark:bg-amber-500/20 dark:border-amber-400/60 shadow-sm'
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="w-4 h-4 text-amber-500 border-slate-300 dark:border-slate-700 focus:ring-amber-400 bg-white dark:bg-slate-900"
                                                />
                                                <div className="flex-1 min-w-0">
                                ...
                                {errors.nominee_id && <p className="text-xs text-rose-500 dark:text-rose-400 mt-2">{errors.nominee_id}</p>}
                            </div>
