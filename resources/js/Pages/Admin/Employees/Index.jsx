        ...
        <AdminLayout title="Master Data Karyawan">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                    <input
                        ...
                        className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs text-slate-200 placeholder-slate-500 focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {filteredEmployees.length === 0 ? (
                    <div className="col-span-full py-16 text-center text-slate-500 bg-[#0a0f1d] rounded-2xl border border-slate-800">
                    ...
                    filteredEmployees.map((emp) => (
                        <div
                            key={emp.id}
                            className="p-5 rounded-2xl bg-[#0a0f1d] border border-amber-500/15 hover:border-amber-500/30 transition-all flex items-start gap-4 shadow-lg group"
                        >
                            {/* Photo */}
                            <div className="w-16 h-16 rounded-2xl bg-slate-800 border border-amber-500/30 overflow-hidden flex-shrink-0 flex items-center justify-center relative">
                                {emp.photo_url ? (
                                    <img 
                                        src={emp.photo_url} 
                                        alt={emp.name} 
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 text-xs text-amber-400 mt-1 truncate">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.position && <p className="text-xs text-rose-400 mt-1">{errors.position}</p>}
                                </div>
