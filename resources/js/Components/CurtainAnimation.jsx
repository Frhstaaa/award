...
export default function CurtainAnimation({ isOpen = false, children }) {
    return (
        <div className="relative w-full h-[450px] sm:h-[490px] md:h-[530px] lg:h-[560px] overflow-hidden rounded-3xl border-2 border-amber-400/60 bg-gradient-to-b from-[#fffdfa] via-[#fef6e5] to-[#fbf0d8] text-amber-950 shadow-[0_25px_60px_-15px_rgba(180,83,9,0.22),0_0_40px_rgba(245,158,11,0.25)] dark:bg-gradient-to-b dark:from-[#181107] dark:via-[#110c04] dark:to-[#080502] dark:text-amber-50 dark:shadow-[0_16px_50px_rgba(0,0,0,0.8),0_0_30px_rgba(245,158,11,0.18)] flex items-center justify-center transition-colors duration-300">
            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-10">
                {children}
            </div>
            ...
            >
                ...
                <div className="absolute top-3 left-4 px-3 py-1 rounded bg-black/50 border border-amber-400/40 text-amber-200 text-[11px] sm:text-xs font-display tracking-widest uppercase shadow">
                    Award Stage
                </div>
            </motion.div>
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 h-3 bg-gradient-to-r from-amber-600 via-yellow-400 to-amber-600 border-t border-amber-300/40" />
                <div className="absolute top-3 right-4 px-3 py-1 rounded bg-black/50 border border-amber-400/40 text-amber-200 text-[11px] sm:text-xs font-display tracking-widest uppercase shadow">
                    Excellence
                </div>
            </motion.div>

            {/* Top Pelmet / Valance Drapery Banner */}
            <div className="absolute top-0 left-0 right-0 h-9 sm:h-10 md:h-11 z-30 bg-gradient-to-b from-[#fef3c7] via-[#fde68a] to-[#fcd34d] border-b-2 border-amber-500/80 dark:bg-gradient-to-b dark:from-[#2a1705] dark:to-[#120a02] dark:border-amber-400/70 flex items-center justify-center shadow-md transition-colors duration-300">
                <div className="h-0.5 w-20 sm:w-28 bg-gradient-to-r from-transparent via-amber-600 dark:via-amber-400 to-transparent" />
                <div className="mx-4 text-xs sm:text-sm font-display tracking-widest text-amber-950 dark:text-amber-300 uppercase flex items-center gap-2 font-black">
                    <span className="text-amber-700 dark:text-amber-400 text-[10px] sm:text-xs">✦</span>
